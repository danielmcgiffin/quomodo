...
--
-- Notes:
-- - Pass an existing auth.users.id as owner user id.
-- - The function creates a new org + owner membership + starter triad data.
-- - Safe to run multiple times; each run creates a fresh org.
