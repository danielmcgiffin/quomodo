...
1.  
**Location/identifier:** `src/routes/(admin)/account/+layout.server.ts:137`, `src/routes/(marketing)/login/+layout.server.ts:10`, consumed in `src/routes/(admin)/account/+layout.ts:29`  
...
2.  
**Location/identifier:** `supabase/migrations/20240730010101_initial.sql:71-72`  
...
3.  
**Location/identifier:** `supabase/migrations/20260211183000_systemscraft_triad_foundation.sql:387-447` (`sc_reorder_action`)  
...
4.  
**Location/identifier:** `supabase/migrations/20260211194500_add_systemscraft_seed_function.sql:6-...` (`sc_seed_demo`)  
...
5.  
**Location/identifier:** `supabase/migrations/20260211183000_systemscraft_triad_foundation.sql:510-514` (`orgs_update_owner_admin` policy)  
...
6.  
**Location/identifier:** `supabase/migrations/20260211183000_systemscraft_triad_foundation.sql:324-335` (`sc_is_org_member`)  
...
7.  
**Location/identifier:** `supabase/migrations/20260213104500_add_org_invites.sql:24-26`, `src/routes/app/team/+page.server.ts:309,394`  
...
8.  
**Location/identifier:** `src/routes/(marketing)/invite/[token]/+page.server.ts:180-185`  
...
9.  
**Location/identifier:** `src/routes/app/team/+page.server.ts:116-123,314`, `supabase/migrations/20260213123000_add_org_ownership_transfers.sql:202`  
...
10.  
**Location/identifier:** `src/routes/app/team/+page.server.ts:498-541`  
...
11.  
**Location/identifier:** `src/routes/app/processes/[slug]/+page.server.ts:344-375`  
...
12.  
**Location/identifier:** `src/lib/server/app/actions/shared.ts:762-806` (`resequenceProcessActions`)  
...
13.  
**Location/identifier:** `src/routes/app/processes/[slug]/+page.server.ts:103-106`, `src/lib/server/app/actions/shared.ts:668-699`  
...
14.  
**Location/identifier:** `src/lib/server/app/mappers/search.ts:263-267`, migration `20260217000000_add_action_title.sql:43`  
...
15.  
**Location/identifier:** `src/routes/app/search/+server.ts:109,115,121`  
...
16.  
**Location/identifier:** `supabase/migrations/20260211183000_systemscraft_triad_foundation.sql` (view at ~242, indexes at ~214-238)  
...
17.  
**Location/identifier:** `src/lib/mailer.ts:9-27,50-52`, usage `src/routes/app/team/+page.server.ts:422,711,724`  
...
18.  
**Location/identifier:** `src/lib/server/billing.ts:233-245`, callers in `src/routes/app/+layout.server.ts:55` and `src/lib/server/app/actions/wrapAction.ts:56`  
...
19.  
**Location/identifier:** `src/routes/(admin)/account/subscribe/[slug]/+page.server.ts:61-64`  
...
20.  
**Location/identifier:** `src/routes/app/workspace/+page.server.ts:117-118`  
...
21.  
**Location/identifier:** `scripts/seed-e2e.mjs:36-37`  
...
22.  
**Location/identifier:** `supabase/migrations/20260213190854_populate_daniel_dev_shop.sql` (empty file)  
...
23.  
**Location/identifier:** `src/DatabaseDefinitions.ts` actions table section (~402 onward) vs `supabase/migrations/20260217000000_add_action_title.sql:3`  
...
24.  
**Location/identifier:** `npm audit --omit=dev --json` (current dependency graph)  
...
25.  
**Location/identifier:** `src/routes/app/team/+page.server.ts:189-195`  
