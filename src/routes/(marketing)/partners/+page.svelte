<svelte:head>
  ...
  <meta
    name="description"
    content="Consultant and operator partner program for deploying SystemsCraft across client engagements."
  />
</svelte:head>
...
<section class="mk-section">
  <div class="mk-section-head">
    <h2>How partner delivery works</h2>
    <p>One model, repeatable execution.</p>
  </div>
